...
- [Qibla compass — 2D Canvas](qibla-compass.md) — Three.js replaced with 2D Canvas; iOS uses webkitCompassHeading, Android uses e.absolute+alpha; vibration is one-shot (hysteresis via _wasAligned).
